...
if(!empty($arResult['ERRORS']['FATAL'])):
	...
	?>
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="line    bx-sls <?= ($arResult['MODE_CLASSES'] !== '' ? $arResult['MODE_CLASSES'] : ''); ?>">
		...
		<div class="<?=$dropDownBlock?> bx-ui-sls-input-block    field">

			<span class="dropdown-icon"></span>
			<input type="text" autocomplete="off" name="<?=$arParams['INPUT_NAME']?>" value="<?=$arResult['VALUE']?>" class="dropdown-field input" placeholder="<?=Loc::getMessage('SALE_SLS_INPUT_SOME')?> ..." />
