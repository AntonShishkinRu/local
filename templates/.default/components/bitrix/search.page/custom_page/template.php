...
?>
<div class="search search_page_form">
...
<?else:?>
	<input type="text" name="q" class="input left" value="<?=$arResult["REQUEST"]["QUERY"]?>"  placeholder="Поиск" />
<?endif;?>
...
<?endif;?>
	<button type="submit" class="submit_btn left">Искать</button>
