...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	<div id="basket-root" class="bx-basket bx-step-opacity cart_info   data" style="opacity: 0;">
		...
		<div class="basket-items-list-wrapper--CUSTOM basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?=$displayModeClass?>  list"
			...
			<div class="basket-items-list-container" id="basket-items-list-container">
				...
				<div class="basket-items-list--CUSTOM" id="basket-item-list">
					...
					<div class="basket-items-list-table list" id="basket-item-table"></div>
				</div>
			</div>
		</div>
		...
		?>
		<button class="clear_btn" onclick="location.href='/personal/cart/?clear=1'">
